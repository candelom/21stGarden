<?php
	...
	function sf_admin_css() {
	    ...
	    <style type="text/css" media="screen">
	    	#menu-posts-portfolio div.wp-menu-image:before, #menu-posts-team div.wp-menu-image:before, #menu-posts-clients div.wp-menu-image:before, #menu-posts-testimonials div.wp-menu-image:before, #menu-posts-jobs div.wp-menu-image:before, #menu-posts-faqs div.wp-menu-image:before, #menu-posts-galleries div.wp-menu-image:before {
	    		display: none;
	    	}
	        #menu-posts-portfolio .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/portfolio.png) no-repeat 9px 9px!important;
	        	background-size: 17px 15px;
	        }
	        #menu-posts-portfolio:hover .wp-menu-image, #menu-posts-portfolio.wp-has-current-submenu .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/portfolio_rollover.png) no-repeat 9px 9px!important;
	        }
	        #menu-posts-team .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/team.png) no-repeat 9px 12px!important;
	        	background-size: 18px 9px;
	        }
	        #menu-posts-team:hover .wp-menu-image, #menu-posts-team.wp-has-current-submenu .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/team_rollover.png) no-repeat 9px 12px!important;
	        }
	        #menu-posts-clients .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/clients.png) no-repeat 10px 9px!important;
	        	background-size: 15px 16px;
	        }
	        #menu-posts-clients:hover .wp-menu-image, #menu-posts-clients.wp-has-current-submenu .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/clients_rollover.png) no-repeat 10px 9px!important;
	        }
	        #menu-posts-testimonials .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/testimonials.png) no-repeat 10px 9px!important;
	        	background-size: 15px 14px;
	        }
	        #menu-posts-testimonials:hover .wp-menu-image, #menu-posts-testimonials.wp-has-current-submenu .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/testimonials_rollover.png) no-repeat 10px 9px!important;
	        }
	        #menu-posts-jobs .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/jobs.png) no-repeat 10px 10px!important;
	        	background-size: 16px 14px;
	        }
	        #menu-posts-jobs:hover .wp-menu-image, #menu-posts-jobs.wp-has-current-submenu .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/jobs_rollover.png) no-repeat 10px 10px!important;
	        }
	        #menu-posts-faqs .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/faqs.png) no-repeat 10px 9px!important;
	        	background-size: 15px 16px;
	        }
	        #menu-posts-faqs:hover .wp-menu-image, #menu-posts-faqs.wp-has-current-submenu .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri(); ?>/images/wp/faqs_rollover.png) no-repeat 10px 9px!important;
	        }
